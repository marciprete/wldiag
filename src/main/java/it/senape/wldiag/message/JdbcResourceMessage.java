 ...
 */
public class JdbcResourceMessage implements Serializable {
    ...
    private LocalDateTime lastSuccessfulConnectionUse; //1516872070308
    ...
    public LocalDateTime getLastSuccessfulConnectionUse() {
        return lastSuccessfulConnectionUse;
    }

    public void setLastSuccessfulConnectionUse(LocalDateTime lastSuccessfulConnectionUse) {

...
@XmlSeeAlso({
    JdbcPoolComponentType.class,
    EjbComponentType.class,
    WebAppComponentType.class,
    ConnectorComponentType.class
})
public class ComponentType
    extends DeploymentType
{

    @XmlElementRef(name = "uri", namespace = "http://xmlns.oracle.com/weblogic/domain", type = JAXBElement.class, required = false)
